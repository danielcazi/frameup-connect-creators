...
import { Video, LogOut, Search, Briefcase } from 'lucide-react';
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Bem-vindo de volta! Encontre novos projetos e gerencie seus trabalhos.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-xl border border-border bg-card p-6 transition-all hover:border-primary/50 hover:shadow-lg">
            ...
            <p className="mb-4 text-sm text-muted-foreground">
              Encontre novos projetos de edição disponíveis
            </p>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="mb-6 text-muted-foreground">
            Comece a buscar projetos no marketplace para se candidatar
          </p>
