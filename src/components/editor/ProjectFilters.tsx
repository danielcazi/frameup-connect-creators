                ...
                <div className="flex flex-wrap gap-2">
                    {EDITING_STYLES.map((style) => (
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${filters.editingStyle.includes(style.value)
                                    ? 'bg-primary text-primary-foreground'
                                    : 'bg-secondary text-secondary-foreground hover:bg-secondary/80'
                                }`}
                        >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                    {DEADLINE_OPTIONS.map((option) => (
                        <button
                            ...
                            className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${filters.maxDeadline === option.value
                                    ? 'bg-primary text-primary-foreground'
                                    : 'bg-secondary text-secondary-foreground hover:bg-secondary/80'
                                }`}
                        >
